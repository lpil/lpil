...
The outcome should be ordered by points, descending. In case of a tie, the
team with the most wins is ranked higher. If the teams have the same number of
wins, then teams are ordered alphabetically.
