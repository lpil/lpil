...
let tests =
  ...
  ; "does not detect false positives" >:: ae [] (anagrams "galea" ["eagle"])
  ; "detects two anagrams"
    >:: ae ["stream"; "maters"]
          (anagrams "master" ["stream"; "pigeon"; "maters"])
  ...
  ; "capital word is not own anagram" >:: ae [] (anagrams "BANANA" ["Banana"])
  ]


let () = run_test_tt_main ("anagrams tests" >::: tests)
