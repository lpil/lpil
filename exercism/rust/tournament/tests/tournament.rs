...
#[test]
fn test_single_line() {
    let input = "Allegoric Alaskians;Blithering Badgers;win".to_string();
...
#[test]
fn test_even_points() {
    let input = "Devastating Donkeys;Blithering Badgers;draw\n".to_string() +
        "Devastating Donkeys;Allegoric Alaskians;draw\n" +
        "Courageous Californians;Blithering Badgers;draw\n" +
        "Allegoric Alaskians;Courageous Californians;draw";
    let expected = "Team                           | MP |  W |  D |  L |  P\n".to_string() +
        "Allegoric Alaskians            |  2 |  0 |  2 |  0 |  2\n" +
        "Blithering Badgers             |  2 |  0 |  2 |  0 |  2\n" +
        "Courageous Californians        |  2 |  0 |  2 |  0 |  2\n" +
        "Devastating Donkeys            |  2 |  0 |  2 |  0 |  2";
