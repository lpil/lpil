...
encodeCases :: [Case]
encodeCases =
  [ Case {description = "encode empty string", input = "", expected = ""}
  , Case
  ...
  , Case
    {description = "encode simple", input = "AABBBCCCC", expected = "2A3B4C"}
  , Case
  ...
  , Case
    { description = "encode whitespace"
    , input = "  hsqq qww  "
    , expected = "2 hs2q q2w2 "
    }
  , Case
    {description = "encode lowercase", input = "aabbbcccc", expected = "2a3b4c"}
  ]

decodeCases :: [Case]
decodeCases =
  [ Case {description = "decode empty string", input = "", expected = ""}
  , Case
  ...
  , Case
    {description = "decode simple", input = "2A3B4C", expected = "AABBBCCCC"}
  , Case
  ...
  , Case
    { description = "decode whitespace"
    , input = "2 hs2q q2w2 "
    , expected = "  hsqq qww  "
    }
  , Case
    {description = "decode lowercase", input = "2a3b4c", expected = "aabbbcccc"}
  ]
